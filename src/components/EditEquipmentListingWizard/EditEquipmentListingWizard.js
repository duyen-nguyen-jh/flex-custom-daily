...
const RedirectToStripe = ({ redirectFn }) => {
  ...
  return <FormattedMessage id="EditEquipmentListingWizard.redirectingToStripe" />;
};
  ...
  render() {
    ...
    return (
      <div className={classes}>
        ...
        <Modal
          id="EditEquipmentListingWizard.payoutModal"
        ...
        >
          <div className={css.modalPayoutDetailsWrapper}>
            <h1 className={css.modalTitle}>
              <FormattedMessage id="EditEquipmentListingWizard.payoutModalTitleOneMoreThing" />
              <br />
              <FormattedMessage id="EditEquipmentListingWizard.payoutModalTitlePayoutPreferences" />
            </h1>
            {!currentUserLoaded ? (
              ...
              <>
                <p className={css.modalMessage}>
                  <FormattedMessage id="EditEquipmentListingWizard.payoutModalInfo" />
                </p>
