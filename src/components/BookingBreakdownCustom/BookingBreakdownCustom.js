...
import css from './BookingBreakdownCustom.module.css';

export const BookingBreakdownCustomComponent = props => {
  const {
    rootClassName,
    className,
    userRole,
  ...
  /**
   * BookingBreakdownCustom contains different line items:
   *
   ...
   * This line item is not used by default in the BookingBreakdownCustom.
   *
...
BookingBreakdownCustomComponent.defaultProps = {
  rootClassName: null,
  className: null,
  dateType: null,
  timeZone: null,
...
BookingBreakdownCustomComponent.propTypes = {
...
const BookingBreakdownCustom = injectIntl(BookingBreakdownCustomComponent);

BookingBreakdownCustom.displayName = 'BookingBreakdownCustom';

export default BookingBreakdownCustom;
